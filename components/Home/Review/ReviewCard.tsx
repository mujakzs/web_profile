  ...
  return (
    <div className='bg-gray-100 p-6 rounded-lg mr-4 shadow-md'>
        ...
        <p className='mt-4 text-base md:text-lg font-medium text-gray-800'>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nemo animi quasi sit.
             Sequi assumenda quis, facere laborum fugiat quod labore eos debitis in, nostrum
              laboriosam ad. In vitae velit deleniti.
        </p>
