        ...
        <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
            ...
            <div>
                ...
                <h1 className='text-2xl md:text-3xl lg:text-5xl mt-3 font-bold leading-[1.8rem] md:leading-[3rem]'>
                    We are a team of talented engineers and designers
                    who are passionate about Technology.
                </h1>
                <p className='mt-3 text-gray-700 dark:text-gray-300'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab totam tempore deserunt. 
                    Dolore sit, animi voluptatibus et voluptas quos recusandae sunt tempore explicabo placeat 
                    molestias quod sequi repellendus deleniti eius.
                </p>
