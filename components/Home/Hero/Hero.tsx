...
const Hero = () => {
  return (
    <div className='relative bg-blue-950 w-full h-screen flex justify-center flex-col' id="hero">
        <div className='w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10 '>
            ...
            <div data-aos="fade-right" data-aos-delay="500">
                ...
                <p className='text-sm sm:text-base md:text-lg font-medium text-gray-300'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto veniam nesciunt odio exercitationem, alias eius maiores tempora
                </p>
                ...
                <a href="#"
                    className='relative inline-flex mt-8 items-center justify-start px-6 py-3 overflow-hidden font-medium 
                        ...
                        <span className='w-48 h-48 rounded rotate-[-40deg] bg-purple-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500
